...
import { VEGIIS_VARIANTS } from '@/models/product.model'
...
export default function Orders() {
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            try {
                const response = await apiClient.getUserOrder()
                setOrders(response)
            } catch (error) {
            ...
            <div className="space-y-6">
                {orders.map((order) => {
                    const variantDimensions =
                        VEGIIS_VARIANTS[
                            order.variant.type.toUpperCase() as keyof typeof VEGIIS_VARIANTS
                        ];
                            ...
                            <div className="card-body">
                                <div className="flex flex-col md:flex-row gap-6">
                                    ...
                                    <div
                                        ...
                                        style={{
                                            width: "200px",
                                            aspectRatio: `${variantDimensions} / ${variantDimensions}`,
                                        }}
                                    >
                                        {/* <input
                                        ...
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="text-right">
                                                ...
                                                {order.status === "completed" && (
                                                    <a
                                                        href={`${process.env.NEXT_PUBLIC_URL_ENDPOINT}/tr:q-100,w-${variantDimensions},h-${variantDimensions},cm-extract,fo-center/${product.imageUrl}`}
                                                        target="_blank"
